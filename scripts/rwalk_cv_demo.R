...
rw_bin20 <- rwalk_cv(dead_space_distance = 4)
rw_bin10 <- rwalk_cv(dead_space_distance = 4, bin_size = 1.0)
rw_bin05 <- rwalk_cv(dead_space_distance = 4, bin_size = .5)

# How about just releasing at the end?
# rw_bin20 <- rwalk_cv(electrode_distance = 50, dead_space_distance = 48)
# rw_bin10 <- rwalk_cv(electrode_distance = 50, dead_space_distance = 49, bin_size = 1.0)
# rw_bin05 <- rwalk_cv(electrode_distance = 50, dead_space_distance = 49.5, bin_size = .5)
