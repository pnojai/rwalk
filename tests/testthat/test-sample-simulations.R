...
test_that("CV bin 1 matches matches corrected sample", {
        # Open the Excel example.
        # Read the data range you're interested in, namely the matrix.
        ...
        # Read simulation
        xlsx <- readWorkbook("./../testdata/RW_CV_corrected2.xlsx", sheet = 1, startRow = 8, colNames = FALSE,
        ...
        # print(head(xlsx_results))
        # print(head(rw[, 1:2]))
        
        expect_equivalent(xlsx_results, rw)
})

test_that("CV simulation electrode matches corrected sample", {
        # Open the Excel example.
        # Read the data range you're interested in, namely the matrix.
        ...
        # Read simulation
        xlsx <- readWorkbook("./../testdata/RW_CV_corrected2.xlsx", sheet = 1, startRow = 8, colNames = FALSE, cols = c(5, 31))
