...
test_that("CV bin 1 matches matches corrected sample", {
        ...
        # Read simulation
        xlsx <- readWorkbook("./../testdata/RW_CV_corrected.xlsx", sheet = 1, startRow = 8, colNames = FALSE,
...
test_that("CV simulation electrode matches corrected sample", {
        ...
        # Read simulation
        xlsx <- readWorkbook("./../testdata/RW_CV_corrected.xlsx", sheet = 1, startRow = 8, colNames = FALSE, cols = c(5, 31))
